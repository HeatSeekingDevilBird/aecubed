...
apiController.noaaData = async (req, res, next) => {
  await fetch(`https://www.ncei.noaa.gov/cdo-web/api/v2/data?enddate=2021-12-31&startdate=2012-08-03&locationid=FIPS:${res.locals.fips}&datasetid=GSOY&datatypeid=PSUN&datatypeid=TAVG&datatypeid=TMAX&datatypeid=TMIN&datatypeid=DX32&datatypeid=DX70&datatypeid=DX90&datatypeid=AWND&datatypeid=WSF2&limit=1000`, {
    headers: {
      'token': NOAA_KEY
    }
  })
